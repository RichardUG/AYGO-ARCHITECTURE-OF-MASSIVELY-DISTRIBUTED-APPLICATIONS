...
public class TweetUserReaction {
    ...
    private String idTweetUserReaction;
    ...
    @DynamoDBHashKey(attributeName = "idTweetUserReaction")
    @DynamoDBAutoGeneratedKey
    public String getIdTweetUserReaction() {
        return idTweetUserReaction;
    }

    public void setIdTweetUserReaction(String idTweetUserReaction) {
        this.idTweetUserReaction = idTweetUserReaction;
    }
